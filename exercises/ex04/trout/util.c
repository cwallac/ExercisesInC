...
Sigfunc *signal(int signo, Sigfunc *func)
{
  ...
  act.sa_flags = 0;
  //Flag is now no op so comment this out. Mac OSX did not leave this for historical reasons 
  //https://www.kernel.org/pub/linux/kernel/people/marcelo/linux-2.4/include/asm-arm/signal.h
  // if (signo == SIGALRM) {
